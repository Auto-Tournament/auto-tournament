...
import { deriveOvertimeOption, type OvertimeOption } from '../ShuffleTournamentConfigStep';
import { SegmentedControl } from './SegmentedControl';

export interface Cs2MatchSettingsValue {
  maxRounds: number;
  overtimeMode?: 'enabled' | 'disabled';
  overtimeSegments?: number | null;
}

interface Cs2MatchSettingsProps {
  value: Cs2MatchSettingsValue;
  onChange: (patch: Partial<Cs2MatchSettingsValue>) => void;
  disabled?: boolean;
