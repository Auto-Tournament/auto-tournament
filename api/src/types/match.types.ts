...
export interface MatchConfig {
  // Auto Tournament CS2 expects matchid to be an integer (DB match ID).
  ...
  wingman?: boolean;
  /**
   * Optional explicit round-limit settings passed through to Auto Tournament CS2.
   ...
   * Auto Tournament CS2 v1.3.0 configuration variables:
   * 
   * - at_autoready_enabled: 0 or 1
   * - at_both_teams_unpause_required: 0 or 1
   * - at_max_pauses_per_team: 0-999
   * - at_pause_duration: 0-999 (seconds)
   * - at_side_selection_enabled: 0 or 1
   * - at_side_selection_time: 1-999 (seconds)
   * - at_gg_enabled: 0 or 1
   * - at_gg_threshold: 0.0-1.0
   * - at_gg_min_score_diff: 0-16 (minimum score difference for .gg, 0 = disabled)
   ...
   *
   * This flag is ignored by the Auto Tournament CS2 plugin itself and is purely
